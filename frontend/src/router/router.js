...
const routes = [
  ...
  {path: '/admin/map', component: AdminMap, name: 'map', meta: {requiresAdminAccess: true },},
  {path: '/admin/addremove', component: AddRemoveAdminView, name: 'admin-addremove', meta: {requiresAdminAccess: true },},
]
